...
const api={CHARS,GROUPS,START_TOLERANCE,PATH_TOLERANCE,fresh,start,active,firstRecord,assist,uncertain,award,resetCards,validate,dist,candidates,advance,resolve};if(typeof module!=='undefined')module.exports=api;else root.RailCore=api;
})(globalThis);
